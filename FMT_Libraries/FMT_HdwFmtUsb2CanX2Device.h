// =====================================================================================
/**
 * @file					FMT_HdwFmtUsb2CanX2Device.h
 * @author					M.Forzieri, Formatech Engineering S.R.L.
 * @date					20/03/2025
 * @brief					Formatech Usb2Can X2 Device
 *
 * @version	Project:		Formatech C++ Hardware Library
 * @version	Language:		ANSI C++
 * -----------------------------------------------------------------------------------
 * @version	Revision summary:
 * @version	1.1.0001		[Initial Release][M.Forzieri][20/03/2025]
 */
// =====================================================================================

#ifndef FMTDEF_HDW_FMTUSB2CANX2DEVICE_H
#define FMTDEF_HDW_FMTUSB2CANX2DEVICE_H
...
// *************************************************************************************
// *************************************************************************************
//	Class CFMT_HdwFmtUsb2CanX2Device
// *************************************************************************************
// *************************************************************************************

#define FMTDEF_HDW_FMTUSB2CANX2DEVICE_RXEVENTPAYLOAD_MAX		0x100000

class FMTDEF_LIB_DLLSPEC CFMT_HdwFmtUsb2CanX2Device : public CFMT_HdwFtdiUartBridgedDevice
{
	// =====================================================================================
	//	TYPES
	// =====================================================================================
...
public:
	...
	public:
		...
		t_FMT_Uint8				m_pucRxEventPayload[FMTDEF_HDW_FMTUSB2CANX2DEVICE_RXEVENTPAYLOAD_MAX];
	...
	class CCanByteOutBufferService;
	class CCanByteInBufferService;
	...
	public:
		...
		friend class CFMT_HdwFmtUsb2CanX2Device;
	...
	// ---[ CCanByteInBufferService ]-----------------------------------------------------

	class FMTDEF_LIB_DLLSPEC CCanByteInBufferService : public CFMT_HdwCanByteInBufferService
	{
	protected:

	public:

		CCanByteInBufferService(CFMT_HdwObject* pPort);
		~CCanByteInBufferService();
	};


	// ---[ CCanByteOutBufferService ]-----------------------------------------------------

	class FMTDEF_LIB_DLLSPEC CCanByteOutBufferService : public CFMT_HdwCanByteOutBufferService
	{
	protected:

	public:

		CCanByteOutBufferService(CFMT_HdwObject* pPort);
		~CCanByteOutBufferService();
	};
...
public:
	...
	CFMT_HdwFmtUsb2CanX2Device();
	virtual ~CFMT_HdwFmtUsb2CanX2Device();
