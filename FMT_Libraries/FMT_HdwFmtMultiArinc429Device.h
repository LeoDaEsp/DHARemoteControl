// =====================================================================================
/**
 * @file					FMT_HdwFmtMultiArinc429Device.h
...
#define FMTDEF_HDW_FMTMULTIARINC429DEVICE_H
...
// *************************************************************************************
// *************************************************************************************
//	Class CFMT_HdwFmtMultiArinc429Device
// *************************************************************************************
// *************************************************************************************

#define FMTDEF_HDW_FMTMULTIARINC429DEVICE_RXEVENTPAYLOAD_MAX		0x100000

class FMTDEF_LIB_DLLSPEC CFMT_HdwFmtMultiArinc429Device : public CFMT_HdwHoeFtdiUartBridgedDevice
{
	// =====================================================================================
	//	TYPES
	// =====================================================================================
...
public:
	...
	public:
		...
		t_FMT_Uint8				m_pucRxEventPayload[FMTDEF_HDW_FMTMULTIARINC429DEVICE_RXEVENTPAYLOAD_MAX];
	...
	public:
		...
		friend class CFMT_HdwFmtMultiArinc429Device;
...
public:
	...
	CFMT_HdwFmtMultiArinc429Device();
	virtual ~CFMT_HdwFmtMultiArinc429Device();
...
protected:
	...
	virtual CFMT_HdwHoeFtdiUartBridgedDevice::CDeviceInstance*	CreateDeviceInstance();
