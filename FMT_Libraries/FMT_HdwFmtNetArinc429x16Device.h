// =====================================================================================
/**
 * @file					FMT_HdwFmtNetArinc429x16Device.h
 * @author					M.Forzieri, Formatech Engineering S.R.L.
 * @date					22/07/2022
 * @brief					Formatech NetArinc429x16 Device
 *
...
#define FMTDEF_HDW_FMTNETARINC429X16DEVICE_H
...
// *************************************************************************************
// *************************************************************************************
//	Class CFMT_HdwFmtNetArinc429x16Device
// *************************************************************************************
// *************************************************************************************

#define FMTDEF_HDW_FMTNETARINC429X16DEVICE_RXEVENTPAYLOAD_MAX		0x100000

class FMTDEF_LIB_DLLSPEC CFMT_HdwFmtNetArinc429x16Device : public CFMT_HdwHoeFtdiUartBridgedDevice
{
	// =====================================================================================
	//	TYPES
	// =====================================================================================
...
protected:
	...
	enum t_Command
	{
		...
		e_Command_AtxConfig5	= 0x18,
		e_Command_AtxConfig6	= 0x19,
		e_Command_AtxConfig7	= 0x1A,
		e_Command_AtxConfig8	= 0x1B,
		e_Command_AtxConfig9	= 0x1C,
		e_Command_AtxConfig10	= 0x1D,
		e_Command_AtxConfig11	= 0x1E,
		e_Command_AtxConfig12	= 0x1F,
		e_Command_AtxConfig13	= 0x20,
		e_Command_AtxConfig14	= 0x21,
		e_Command_AtxConfig15	= 0x22,
		e_Command_AtxConfig16	= 0x23,

		e_Command_ArxConfig1	= 0x24,
		e_Command_ArxConfig2	= 0x25,
		e_Command_ArxConfig3	= 0x26,
		e_Command_ArxConfig4	= 0x27,
		e_Command_ArxConfig5	= 0x28,
		e_Command_ArxConfig6	= 0x29,
		e_Command_ArxConfig7	= 0x2A,
		e_Command_ArxConfig8	= 0x2B,
		e_Command_ArxConfig9	= 0x2C,
		e_Command_ArxConfig10	= 0x2D,
		e_Command_ArxConfig11	= 0x2E,
		e_Command_ArxConfig12	= 0x2F,
		e_Command_ArxConfig13	= 0x30,
		e_Command_ArxConfig14	= 0x31,
		e_Command_ArxConfig15	= 0x32,
		e_Command_ArxConfig16	= 0x33
	};
...
public:
	...
	public:
		...
		t_FMT_Uint8				m_pucRxEventPayload[FMTDEF_HDW_FMTNETARINC429X16DEVICE_RXEVENTPAYLOAD_MAX];
		...
		CArinc429TxCtrlStatus	m_AtxCtrlStatus[16];
		CArinc429RxCtrlStatus	m_ArxCtrlStatus[16];
	...
	public:
		...
		friend class CFMT_HdwFmtNetArinc429x16Device;
...
public:
	...
	CFMT_HdwFmtNetArinc429x16Device();
	virtual ~CFMT_HdwFmtNetArinc429x16Device();
...
protected:
	...
	//! Attach an Arinc429 Rx Configuration Command to Command List
            t_FMT_Uint32	AttachArxConfigCommand(t_FMT_Uint32 uiDeviceId, t_FMT_Uint32 uiChannelId, CArinc429RxPort::CParameters *pParam);
