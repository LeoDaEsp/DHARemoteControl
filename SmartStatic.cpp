// SmartStatic.cpp : implementation file
//
...
BEGIN_MESSAGE_MAP(CSmartStatic, CStatic)
	//{{AFX_MSG_MAP(CSmartStatic)
...
/////////////////////////////////////////////////////////////////////////////
// CSmartStatic message handlers


HBRUSH CSmartStatic::CtlColor(CDC* pDC, UINT nCtlColor) 
{
...
void CSmartStatic::SetTextColor(COLORREF crTextColor)
{
...
COLORREF CSmartStatic::GetTextColor()
{
	return m_crTextColor;
} // End of GetTextColor


void CSmartStatic::SetBkColor(COLORREF crBkColor)
{
...
COLORREF CSmartStatic::GetBkColor()
{
	return m_crBkColor;
} // End of GetBkColor


void CSmartStatic::SetBlinkTextColors(COLORREF crBlinkTextColor1, COLORREF crBlinkTextColor2)
{
...
void CSmartStatic::StartTextBlink(BOOL bStart, UINT nElapse)
{
	UINT nCount;
...
void CSmartStatic::SetBlinkBkColors(COLORREF crBlinkBkColor1, COLORREF crBlinkBkColor2)
{
...
void CSmartStatic::StartBkBlink(BOOL bStart, UINT nElapse)
{
	UINT nCount;
...
void CSmartStatic::EnableNotify(CWnd* pParent, UINT nMsg)
{
	m_pParent = pParent;
	m_nMsg = nMsg;
} // End of EnableNotify
...
const short CSmartStatic::GetVersionI()
{
	return 10; // Divide by 10 to get actual version
} // End of GetVersionI


const char* CSmartStatic::GetVersionC()
{
	return "1.0";
} // End of GetVersionC


void CSmartStatic::OnTimer(UINT nIDEvent) 
{
