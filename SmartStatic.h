#ifndef _SmartStatic_H
#define _SmartStatic_H

#if _MSC_VER >= 1000
#pragma once
#endif // _MSC_VER >= 1000

// SmartStatic.h : header file
//

class CSmartStatic : public CStatic
{
// Construction
public:
	CSmartStatic();
...
// Overrides
	...
	//{{AFX_VIRTUAL(CSmartStatic)
	//}}AFX_VIRTUAL

// Implementation
public:
	virtual ~CSmartStatic();
